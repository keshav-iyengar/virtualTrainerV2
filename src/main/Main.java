...
public class Main {
	...
	protected void createContents() {
		...
		CLabel lblTestWorkout = new CLabel(yourWorkoutComposite, SWT.NONE);
		lblTestWorkout.setBounds(188, 115, 209, 21);
		formToolkit.adapt(lblTestWorkout);
		formToolkit.paintBordersFor(lblTestWorkout);
		lblTestWorkout.setText("Test workout");
